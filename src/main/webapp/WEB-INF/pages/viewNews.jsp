		...
		<div align="left">
			...
			<table class="news_text_format">
				<tr>
					...
					<td class="space_around_view_text"><div class="word-breaker">${newsForView.title }</div></td>
				</tr>
				<tr>
					<td class="space_around_title_text">News date:</td>

					<td class="space_around_view_text"><div class="word-breaker">${newsForView.newsDate}</div></td>
				</tr>
				<tr>
					<td class="space_around_title_text">News brief:</td>
					<td class="space_around_view_text"><div class="word-breaker">${newsForView.briefNews}"</div></td>
				</tr>
				<tr>
					<td class="space_around_title_text">News content:</td>
					<td class="space_around_view_text"><div class="word-breaker">${newsForView.content}</div></td>
				</tr>

			</table>

			<c:url var="editLink" value="/news/showFormForEdit">
				<c:param name="newsId" value="${newsForView.idNews}" />
			</c:url>
			...
			<div class="news-link-to-wrapper">
				<div class="link-position">
					<a href="${editLink}">edit</a> &nbsp </a> &nbsp <a href="${deleteLink}"
				...
				<div align="right">
					...
					<form:form action="list" method="POST" modelAttribute="newsForView">
						<br />
